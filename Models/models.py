...
def fix_duplicates(correct_name_list):
    no_duplicates = []
...
fix_duplicates_list = fix_duplicates(correct_name_list)

correct_list = updating_phone_numbers(fix_duplicates_list, regular, r'+7(\2)\3-\4-\5')
